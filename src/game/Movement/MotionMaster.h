...
enum MovementGeneratorType
{
    ...
    TIMED_FLEEING_MOTION_TYPE =
        13,                  // FleeingMovementGenerator.h (alt.second part of flee for assistance)
...
public:
    ...
    auto begin() const -> decltype(c.begin()) { return c.begin(); }
    auto end() const -> decltype(c.end()) { return c.end(); }
    auto begin() -> decltype(c.begin()) { return c.begin(); }
    auto end() -> decltype(c.begin()) { return c.end(); }
    ...
    void
    MoveJump(float x, float y, float z, float horizontalSpeed, float max_height, uint32 id = 0);
